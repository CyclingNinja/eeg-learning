"""Tests for DatasetBuilder (eeg_learning/io/dataset_builder.py)."""
...
class TestLoadSavedWindows:
    @patch("eeg_learning.io.dataset_builder.load_concat_dataset")
...
class TestWindow:
    @patch("eeg_learning.io.dataset_builder.create_fixed_length_windows")
